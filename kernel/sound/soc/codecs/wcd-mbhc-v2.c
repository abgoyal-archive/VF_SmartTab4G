...
//[PLATFORM]-Mod-BEGIN by TCTSZ.yaohui.zeng, 2014/09/6,mod to reduce detect time
...
//[PLATFORM]-Mod-END by TCTSZ.yaohui.zeng, 2014/09/6
...
//[PLATFORM]-Mod-END by TCTSZ.yaohui.zeng, 2014/09/6
		...
		if (delay == SPECIAL_HS_DETECT_TIME_MS) {
			pr_debug("%s: Spl headset didnt get detect in 4 sec\n",
					__func__);
//[PLATFORM]-Mod-BEGIN by TCTSZ.yaohui.zeng, 2014/09/06, Temporary!!! add to detect iphone5s headset,will fix later
#ifdef CONFIG_TCT_8X16_POP8LTE
			result2 = 0;
#endif
//[PLATFORM]-Mod-END by TCTSZ.yaohui.zeng, 2014/09/06
			break;
		}
	}
	if (!(result2 & 0x01)) {
...
/* [PLATFORM]-Mod-END by TCTNB.HJ, 2014/08/04*/
		...
		if (result2 == 1) {
			...
			wrk_complete = true;
//[PLATFORM]-Mod-BEGIN by TCTSZ.yaohui.zeng, 2014/09/6,add to reduce detect time
#ifdef CONFIG_TCT_8X16_POP8LTE
			break;
#endif
//[PLATFORM]-Mod-END by TCTSZ.yaohui.zeng, 2014/09/6
...
static void wcd_mbhc_swch_irq_handler(struct wcd_mbhc *mbhc)
{
	...
	if ((mbhc->current_plug == MBHC_PLUG_TYPE_NONE) &&
		...
		snd_soc_update_bits(codec,
				    MSM8X16_WCD_A_ANALOG_MASTER_BIAS_CTL,
				    0x30, 0x30);
//[BUGFIX]-ADD-START TCTSZ.ZKX HW have bypass cap
		#ifndef CONFIG_TCT_8X16_POP8LTE
		snd_soc_update_bits(codec,
				MSM8X16_WCD_A_ANALOG_MICB_1_EN,
				0x44, 0x44);
		#endif
//[BUGFIX]-ADD-END TCTSZ.ZKX
