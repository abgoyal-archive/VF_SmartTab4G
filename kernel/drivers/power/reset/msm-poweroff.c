...
static void msm_restart_prepare(const char *cmd)
{
	 ...
	 */
//[PLATFORM]-Add-BEGIN by TCTSZ.leo.guo, Fix the issue of shift f003 mode to 9006 mode  2014/06/05
#if (defined CONFIG_TCT_8X16_POP8LTE)
	set_dload_mode((restart_mode == RESTART_DLOAD) || (download_mode && in_panic));
#endif
//[PLATFORM]-Add-END
#endif
...
//[PLATFORM]-Add-BEGIN by TCTSZ.leo.guo, Fix the issue of shift f003 mode to 9006 mode, 2014/06/05
//[PLATFORM]-Add-BEGIN by TCTSZ.leo.guo, Fix the issue of shift f003 mode to 9008 mode, 2014/08/18
#if 0 //(defined CONFIG_TCT_8X16_POP8LTE)
