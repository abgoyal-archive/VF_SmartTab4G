...
//[PLATFORM]-Add-BEGIN by TCTSZ.yaohui.zeng, 2014/06/30, use nanosecond to increase accuracy
#define NSECS_PER_USEC 1000ULL
//[PLATFORM]-Add-END by TCTSZ.yaohui.zeng, 2014/06/30
#endif
...
#ifdef CONFIG_TCT_8X16_POP8LTE
//[PLATFORM]-Mod-BEGIN by TCTSZ.yaohui.zeng, 2014/06/30, use nanosecond to increase accuracy
	ret = pwm_config_ns(ctrl->pwm_bl, duty, ctrl->pwm_period);
	if (ret) {
		pr_err("%s: pwm_config_ns() failed err=%d.\n", __func__, ret);
		return;
	}
//[PLATFORM]-Mod-END by TCTSZ.yaohui.zeng, 2014/06/30
#else
...
//[PLATFORM]-Mod-END by TCTSZ.yaohui.zeng, 2014/06/30
	...
	mdss_dsi_parse_dcs_cmds(np, &ctrl_pdata->off_cmds,
        ...
        //[PLATFORM]-Add-BEGIN by TCTSZ.yaohui.zeng, 2014/04/25, Modify LCD sequence
        #ifdef CONFIG_TCT_8X16_POP8LTE
             mdss_dsi_parse_dcs_cmds(np, &on_cmds_sec,
                     "qcom,mdss-dsi-on-command-sec", "qcom,mdss-dsi-on-command-state");

             mdss_dsi_parse_dcs_cmds(np, &off_cmds_sec,
                     "qcom,mdss-dsi-off-command-sec", "qcom,mdss-dsi-off-command-state");
        #endif
        //[PLATFORM]-Add-END by TCTSZ.yaohui.zeng, 2014/04/25
