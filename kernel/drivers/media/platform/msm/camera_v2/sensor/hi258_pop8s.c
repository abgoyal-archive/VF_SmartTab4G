...
static struct msm_sensor_power_setting hi258_pop8s_power_down_setting[] = {
	{
		.seq_type = SENSOR_GPIO,
		.seq_val = SENSOR_GPIO_RESET,
		.config_val = GPIO_OUT_LOW,
...
{0x35, 0xff}, //Y Hi Th
{0x36, 0x00}, //Y Lo Th
{0x37, 0xaf}, //Std Hi Th //Reso Improve Th Low //50
{0x38, 0x00}, //Std Lo Th
...
{0x22, 0x4a}, //LSC R 1b->15 20130125   58
...
{0x8D, 0xc3}, //EXP120 
{0x8E, 0x50}, 
{0x9c, 0x17}, //EXP Limit 1000.00 fps 
{0x9d, 0x70}, 
{0x9e, 0x01}, //EXP Unit 
{0x9f, 0xf4}, 
...
static struct msm_sensor_ctrl_t hi258_pop8s_s_ctrl = {
	...
	#if 1
/*[BUGFIX]-Mod-BEGIN by TCTSZ.ZKX, Add power down sequence, 2014/05/27 */
	.power_setting_array.power_down_setting = hi258_pop8s_power_down_setting,
	.power_setting_array.size_down = ARRAY_SIZE(hi258_pop8s_power_down_setting),
/*[BUGFIX]-Mod-END by TCTSZ.ZKX*/
	#endif
